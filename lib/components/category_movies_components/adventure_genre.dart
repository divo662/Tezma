...
class AdventureGenre extends StatefulWidget {
  const AdventureGenre({Key? key}) : super(key: key);

  @override
  State<AdventureGenre> createState() => _AdventureGenreState();
}

class _AdventureGenreState extends State<AdventureGenre> {
  ...
  void initState() {
    ...
    fetchAdventureGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchAdventureGenre(page: currentPage, query: _searchQuery),
