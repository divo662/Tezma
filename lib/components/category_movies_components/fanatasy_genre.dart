...
class FantasyGenre extends StatefulWidget {
  const FantasyGenre({Key? key}) : super(key: key);

  @override
  State<FantasyGenre> createState() => _FantasyGenreState();
}

class _FantasyGenreState extends State<FantasyGenre> {
  ...
  void initState() {
    ...
    fetchFantasyGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchFantasyGenre(page: currentPage, query: _searchQuery),
