...
class DocumentaryGenre extends StatefulWidget {
  const DocumentaryGenre({Key? key}) : super(key: key);

  @override
  State<DocumentaryGenre> createState() => _DocumentaryGenreState();
}

class _DocumentaryGenreState extends State<DocumentaryGenre> {
  ...
  void initState() {
    ...
    fetchDocumentaryGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchDocumentaryGenre(page: currentPage, query: _searchQuery),
