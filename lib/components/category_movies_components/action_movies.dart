...
class ActionMoviesCategory extends StatefulWidget {
  const ActionMoviesCategory({Key? key}) : super(key: key);

  @override
  State<ActionMoviesCategory> createState() => _ActionMoviesCategoryState();
}

class _ActionMoviesCategoryState extends State<ActionMoviesCategory> {
  ...
  void initState() {
    ...
    fetchActionMovies(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchActionMovies(page: currentPage, query: _searchQuery),
