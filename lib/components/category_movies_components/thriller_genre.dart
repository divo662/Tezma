...
class ThrillerGenre extends StatefulWidget {
  const ThrillerGenre({Key? key}) : super(key: key);

  @override
  State<ThrillerGenre> createState() => _ThrillerGenreState();
}

class _ThrillerGenreState extends State<ThrillerGenre> {
  ...
  void initState() {
    ...
    fetchThrillerGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchThrillerGenre(page: currentPage, query: _searchQuery),
