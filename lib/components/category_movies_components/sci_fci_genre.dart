...
class SciFiGenre extends StatefulWidget {
  const SciFiGenre({Key? key}) : super(key: key);

  @override
  State<SciFiGenre> createState() => _SciFiGenreState();
}

class _SciFiGenreState extends State<SciFiGenre> {
  ...
  void initState() {
    ...
    fetchScienceFictionGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchScienceFictionGenre(page: currentPage, query: _searchQuery),
