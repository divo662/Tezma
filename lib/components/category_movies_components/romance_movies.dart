...
class RomanticMovies extends StatefulWidget {
  const RomanticMovies({Key? key}) : super(key: key);

  @override
  State<RomanticMovies> createState() => _RomanticMoviesState();
}

class _RomanticMoviesState extends State<RomanticMovies> {
  ...
  void initState() {
    ...
    fetchRomanticMovies(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchRomanticMovies(page: currentPage, query: _searchQuery),
