...
class MysteryGenre extends StatefulWidget {
  const MysteryGenre({Key? key}) : super(key: key);

  @override
  State<MysteryGenre> createState() => _MysteryGenreState();
}

class _MysteryGenreState extends State<MysteryGenre> {
  ...
  void initState() {
    ...
    fetchMysteryGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchMysteryGenre(page: currentPage, query: _searchQuery),
