...
class CrimeGenre extends StatefulWidget {
  const CrimeGenre({Key? key}) : super(key: key);

  @override
  State<CrimeGenre> createState() => _CrimeGenreState();
}

class _CrimeGenreState extends State<CrimeGenre> {
  ...
  void initState() {
    ...
    fetchCrimeGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchCrimeGenre(page: currentPage, query: _searchQuery),
