...
class HorrorGenre extends StatefulWidget {
  const HorrorGenre({Key? key}) : super(key: key);

  @override
  State<HorrorGenre> createState() => _HorrorGenreState();
}

class _HorrorGenreState extends State<HorrorGenre> {
  ...
  void initState() {
    ...
    fetchHorrorGenre(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchHorrorGenre(page: currentPage, query: _searchQuery),
