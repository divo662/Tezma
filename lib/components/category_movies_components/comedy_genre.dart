...
class ComedyGenre extends StatefulWidget {
  const ComedyGenre({Key? key}) : super(key: key);

  @override
  State<ComedyGenre> createState() => _ComedyGenreState();
}

class _ComedyGenreState extends State<ComedyGenre> {
  ...
  void initState() {
    ...
    fetchComedyMovies(page: 1).then((movies) {
      setState(() {
        _movies = movies;
      });
    }).catchError((error) {
        ...
        children: [
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchComedyMovies(page: currentPage, query: _searchQuery),
