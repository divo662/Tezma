...
class _TopRatedMoviesScreenState extends State<TopRatedMoviesScreen> {
  ...
  Future<List<MovieModel>> fetchTopRatedMovies1({int page = 1, String? query}) async {
    const apiKey = '9ee736e148e808222f04c1535dc80b64';

    // Fetch top-rated movies if query is not provided
    if (query == null || query.isEmpty) {
      final url =
          'https://api.themoviedb.org/3/movie/top_rated?api_key=$apiKey&page=$page&language=en-US';
    ...
    final url =
        'https://api.themoviedb.org/3/search/movie?api_key=$apiKey&query=$encodedQuery&page=$page&language=en-US';
        ...
        children: [
          Container(
            ...
            child: TextField(
              ...
              onChanged: (query) async {
                final movies = await fetchTopRatedMovies1(query: query);
                setState(() {
                  _movies = movies;
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _searchQuery != null && _searchQuery!.isNotEmpty
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      setState(() {
                        _movies = []; // Set an empty list to reset the movies
                        _searchQuery = null;
          ...
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchTopRatedMovies1(page: currentPage, query: _searchQuery),
