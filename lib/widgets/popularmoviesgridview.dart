...
class _PopularMoviesGridViewState extends State<PopularMoviesGridView> {
  ...
  Future<List<MovieModel>> fetchPopularMovies1({int page = 1, String? query}) async {
    const apiKey = '9ee736e148e808222f04c1535dc80b64';

    // Fetch popular movies if query is not provided
...
// Set an empty list to reset the movies
          ...
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchPopularMovies1(page: currentPage, query: _searchQuery),
