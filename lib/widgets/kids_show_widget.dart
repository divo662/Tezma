...
class KidsShowWidget extends StatefulWidget {
  const KidsShowWidget({Key? key}) : super(key: key);

  @override
  State<KidsShowWidget> createState() => _KidsShowWidgetState();
}

class _KidsShowWidgetState extends State<KidsShowWidget> {
  ...
  Future<List<TvShowModel>> fetchKidsShow1(
    ...
    final url = query == null
        ...
        : "https://api.themoviedb.org/3/search/tv?api_key=$apiKey&query=$query&page=1&language=en-US&certification_country=US&certification.lte=G&include_adult=false";
      ...
      if (data['results'] != null) {
        ...
        final List<TvShowModel> tvShows = results.map((result) {
          return TvShowModel(
            ...
            genres: [],
            // You can include the genres if available
            voteAverage: result['vote_average'].toDouble(),
            firstAirDate: DateTime.parse(result['first_air_date']),
            // Update here
    ...
    throw Exception('Failed to fetch kids TV shows');
  }
        ...
        children: [
                    ...
                    ? Align(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            setState(() {
                              _tvShows =
                                  []; // Set an empty list to reset the TV shows
                              _searchQuery = null;
          ...
          Expanded(
            child: FutureBuilder<List<TvShowModel>>(
              future: fetchKidsShow1(page: currentPage, query: _searchQuery),
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            fetchShowDetails(tvShowId).then((showDetails) {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(builder: (context) {
                                    return ShowDetailsWidget(
                                      ...
                                      showCast: cast, // Assign cast to showCast
                                    );
                                  }),
                                );
                              }).catchError((error) {
