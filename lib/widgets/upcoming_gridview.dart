...
class _UpComingWidgetState extends State<UpComingWidget> {
  ...
  Future<List<MovieModel>> fetchUpcomingMovies1({int page = 1, String? query}) async {
    const apiKey = '9ee736e148e808222f04c1535dc80b64';

    // Fetch upcoming movies if query is not provided
...
// Set an empty list to reset the movies
          ...
          Expanded(
            child: FutureBuilder<List<MovieModel>>(
              future: fetchUpcomingMovies1(page: currentPage, query: _searchQuery),
