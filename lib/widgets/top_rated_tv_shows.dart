...
class TopRatedTvShowWidget extends StatefulWidget {

  const TopRatedTvShowWidget({Key? key}) : super(key: key);

  @override
  State<TopRatedTvShowWidget> createState() => _TopRatedTvShowWidgetState();
}

class _TopRatedTvShowWidgetState extends State<TopRatedTvShowWidget> {
  ...
  Future<List<TvShowModel>> fetchTopRatedTvShows1({int page = 1, String? query}) async {
    ...
    throw Exception('Failed to fetch top rated TV shows');
  }
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<List<TvShowModel>>(
              future: fetchTopRatedTvShows1(page: currentPage, query: _searchQuery),
